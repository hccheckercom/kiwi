 ...
 * Helper Functions
 *
 * Utility functions for Kiwi UI Test theme.
 *
 * @package kiwi-ui-test
 * @generated 2026-05-25T10:56:27.361100
 */
 ...
 * @return mixed
 */
function kiwi_ui_test_config( $key = '', $default = null ) {
	static $config = null;

	if ( null === $config ) {
		$config_file = KIWI_UI_TEST_DIR . '/store-config.php';
 ...
 */
function kiwi_ui_test_component( $name, $args = [] ) {
 ...
 * @return string
 */
function kiwi_ui_test_format_price( $price ) {
 ...
 * @return bool
 */
function kiwi_ui_test_is_plugin_active( $plugin ) {
